...
if __name__ == "__main__":
    ...
    parser.add_argument('--update_statistics', help='Updates received data statistics using information in the upload tracking model',
        action='store_true', default=False)

    parser.add_argument('--print_statistics', help='Prints all of the received data statistics found in the database',
        action='store_true', default=False)

    parser.add_argument('--delete_statistics', help='Delete all received data statistics.',
        action='store_true', default=False)
