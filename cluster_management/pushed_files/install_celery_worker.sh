...
# the queue and app names are declared in constants.py.
directory = /home/ubuntu/beiwe-backend/
command = python3 -m celery -A services.celery_push_notifications worker -Q queue_push_notification --loglevel=info -Ofair --hostname=%%h_notifications --concurrency=10
